...
> - **自分自身を削除する** / **自分自身の管理者フラグを外す**
> - **他にアクティブな管理者がいない状況で、最後の管理者を削除する / 降格する**
>
> 「アクティブな管理者」はロック中ユーザーを除外してカウントします。ロック中の管理者しか居ない状態でその管理者を削除しようとした場合も拒否されるので、先に対象をロック解除してから操作してください。
>
...
2025-05 のリリースで **左サイドバーのユーザー一覧 + 右の権限詳細 + 折りたたみ可能な追加カード** に再設計済み。
