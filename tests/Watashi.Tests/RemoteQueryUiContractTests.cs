...
{
    [Fact]
    public void Remote_pane_keeps_saved_places_and_hides_cross_location_search_controls()
    {
        ...
        var automationNames = doc.Descendants()
            ...
            .ToList();
        automationNames.Should().Contain("リモート一覧をさらに読み込む")
            .And.NotContain("権限内リモート横断検索")
            .And.NotContain("リモート横断検索結果");
    }
